...
const TeamSkillValidation = ({ teamId }) => {
  ...
  if (isLoading) return <div className="text-sm text-gray-500">Loading validation...</div>
  ...
  return (
    <div className={`rounded-lg p-4 border ${isLow ? 'bg-amber-50 border-amber-200' : 'bg-green-50 border-green-200'}`}>
