            ...
            <div className="text-center py-8">
              {result.passed ? (
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-1">{skill.skill_name} is now verified.</p>
                  <button
                    onClick={onClose}
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-1">You need 70% to verify. Try again later.</p>
                  <button
