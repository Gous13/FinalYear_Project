        ...
        <div className="flex-1 overflow-hidden">
          ...
          {step === 'ready' && (
            <div className="h-full flex flex-col items-center justify-center p-8 text-center bg-gradient-to-b from-white to-gray-50">
              <div className="max-w-2xl">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Start Practical Assessment</h3>
                <div className="bg-white border rounded-xl p-6 text-left mb-8 shadow-sm">
                  <h4 className="font-semibold text-gray-900 mb-3">Assessment Rules:</h4>
          ...
          {step === 'questions' && assessment && (
            <div className="h-full flex flex-col md:flex-row overflow-hidden">
              ...
              <div className="w-full md:w-5/12 border-r flex flex-col bg-white overflow-hidden">
                ...
                <div className="p-4 border-t bg-gray-50 flex flex-col gap-3">
                  ...
                  {error && (
                    <div className="flex items-center gap-2 px-3 py-2 bg-red-50 text-red-600 border border-red-100 rounded-lg text-[11px] font-bold animate-pulse">
              ...
              <div className="w-full md:w-7/12 flex flex-col bg-[#0d1117] overflow-hidden">
                ...
                <div className="bg-[#161b22] px-4 py-2 border-b border-white/5 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-[10px] font-bold text-gray-500 uppercase tracking-widest ml-2">solution.py</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <button
                      onClick={handleRun}
                ...
                <div className="flex-1 relative border-b border-white/5">
                  <div className="absolute left-0 top-0 bottom-0 w-12 bg-[#0d1117] border-r border-white/5 flex flex-col items-center py-4 text-[10px] font-mono text-gray-600 select-none">
                ...
                <div className={`h-48 flex flex-col bg-[#0d1117] transition-all border-t border-white/10 ${currentOutput ? 'translate-y-0' : 'translate-y-0'}`}>
                  ...
                  <div className="flex-1 overflow-y-auto p-4 font-mono text-sm">
                    {!currentOutput ? (
                      <div className="text-gray-600 italic text-xs">Run your code to see the output here...</div>
                    ) : (
          ...
          {step === 'result' && result && (
            <div className="h-full flex flex-col items-center justify-center p-8 text-center bg-gray-50">
              <div className="max-w-md w-full bg-white border rounded-2xl p-8 shadow-xl">
                {result.passed ? (
                  <>
                    <div className="w-20 h-20 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-6">
                      <CheckCircle className="w-12 h-12 text-green-600" />
                    </div>
                    <h3 className="text-3xl font-extrabold text-gray-900 mb-2">Verified!</h3>
                    <p className="text-gray-500 mb-6 font-medium">Congratulations! You&apos;ve passed the assessment.</p>
                  </>
                ) : (
                  <>
                    ...
                    <h3 className="text-3xl font-extrabold text-gray-900 mb-2">Not Verified</h3>
                    <p className="text-gray-500 mb-6 font-medium">You didn&apos;t meet the 60% score requirement this time.</p>
                  </>
                )}

                <div className="flex flex-col gap-3 mb-8">
                  <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                    <span className="text-sm font-bold text-gray-600 uppercase">Overall Score</span>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="p-3 border rounded-xl bg-white">
                      ...
                      <p className="text-lg font-bold text-gray-700">{result.easy_score}%</p>
                    </div>
                    <div className="p-3 border rounded-xl bg-white">
                      <p className="text-[10px] font-bold text-gray-400 uppercase mb-1">Hard Task</p>
                      <p className="text-lg font-bold text-gray-700">{result.hard_score}%</p>
                    </div>
                  </div>
                </div>
