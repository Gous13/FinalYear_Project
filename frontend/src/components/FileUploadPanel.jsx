  ...
  return (
    <div className="space-y-4">
      ...
      <div className="border border-gray-200 rounded-lg divide-y">
        {files.length === 0 ? (
          <div className="p-4 text-center text-gray-500 text-sm">No files yet. Upload to share with the team.</div>
        ) : (
          files.map((f) => (
            <div key={f.id} className="flex items-center justify-between p-3 hover:bg-gray-50">
